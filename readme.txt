...
Fixed date/time picking for WordPress 4.6.1
...
1. UPDATED: timepicker.js updated to version 1.6.3 - http://trentrichardson.com/examples/timepicker/
2. FIXED:  Fixed code to account for how WordPress is returning dates in v. 4.6.1  

= 5.35 - 8/13/2016 =

1. Added warnings in case your site is using SSL (e.g. HPTTS://).  This helps uncover issues where the TopBar has images as HTTP:// while the website needs HPTTS://.
2. VALIDATED: Version 5.34 supports WordPress 4.6
